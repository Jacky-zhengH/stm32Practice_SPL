...
void PWM_Init(void)
{
    ...
    GPIOInitSturcture.GPIO_Pin=GPIO_Pin_1;
    ...
    TIM_OCInitStructure.TIM_Pulse=0; //取值的区间在500~2500，对应0.5~2.5ms      //设置ccr（占空比）
...
{
    TIM_SetCompare2(TIM2,Compare);//设置crr的值而非直接设置占空比，这个值是需要实际运算的
}
